...
class TestAppResourceType:
    """Test cases for AppResourceType functionality."""
    ...
    def test_list_should_return_status_200_and_valid_response(self):
        ...
        req = operations.C1APIAppV1AppResourceTypeServiceListRequest(app_id=app_id, page_size=1)
        res = sdk_instance.app_resource_type.list(request=req)
