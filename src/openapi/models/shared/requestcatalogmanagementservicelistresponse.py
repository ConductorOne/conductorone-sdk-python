...
class RequestCatalogManagementServiceListResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[Nullable[List[RequestCatalogManagementServiceListResponseExpandedTypedDict]]]
...
class RequestCatalogManagementServiceListResponse(BaseModel):
    ...
    expanded: OptionalNullable[List[RequestCatalogManagementServiceListResponseExpanded]] = UNSET
    r"""List of serialized related objects."""
