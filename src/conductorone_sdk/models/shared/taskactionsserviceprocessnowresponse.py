...
class TaskActionsServiceProcessNowResponseExpandedTypedDict(TypedDict):
...
class TaskActionsServiceProcessNowResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class TaskActionsServiceProcessNowResponseTypedDict(TypedDict):
    r"""The TaskActionsServiceProcessNowResponse message."""
    ...
    expanded: NotRequired[
        Nullable[List[TaskActionsServiceProcessNowResponseExpandedTypedDict]]
    ]
    r"""The expanded field."""


class TaskActionsServiceProcessNowResponse(BaseModel):
    r"""The TaskActionsServiceProcessNowResponse message."""

    task_view: Annotated[Optional[TaskView], pydantic.Field(alias="taskView")] = None
    r"""Contains a task and JSONPATH expressions that describe where in the expanded array related objects are located. This view can be used to display a fully-detailed dashboard of task information."""

    expanded: OptionalNullable[List[TaskActionsServiceProcessNowResponseExpanded]] = (
        UNSET
    )
    r"""The expanded field."""
