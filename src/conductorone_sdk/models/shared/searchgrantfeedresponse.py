...
class SearchGrantFeedResponseExpandedTypedDict(TypedDict):
...
class SearchGrantFeedResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class SearchGrantFeedResponseTypedDict(TypedDict):
    r"""The SearchGrantFeedResponse message contains a list of grant event results and a nextPageToken if applicable."""

    expanded: NotRequired[Nullable[List[SearchGrantFeedResponseExpandedTypedDict]]]
    r"""The expanded field."""
    list: NotRequired[Nullable[List[AppEntitlementUserBindingFeedViewTypedDict]]]
...
class SearchGrantFeedResponse(BaseModel):
    r"""The SearchGrantFeedResponse message contains a list of grant event results and a nextPageToken if applicable."""

    expanded: OptionalNullable[List[SearchGrantFeedResponseExpanded]] = UNSET
    r"""The expanded field."""

    list: OptionalNullable[List[AppEntitlementUserBindingFeedView]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request."""
