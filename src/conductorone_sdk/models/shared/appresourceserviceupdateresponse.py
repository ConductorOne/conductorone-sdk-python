...
class AppResourceServiceUpdateResponseExpandedTypedDict(TypedDict):
...
class AppResourceServiceUpdateResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class AppResourceServiceUpdateResponseTypedDict(TypedDict):
    r"""The AppResourceServiceUpdateResponse message."""
    ...
    expanded: NotRequired[
        Nullable[List[AppResourceServiceUpdateResponseExpandedTypedDict]]
    ]
    r"""The expanded field."""


class AppResourceServiceUpdateResponse(BaseModel):
    r"""The AppResourceServiceUpdateResponse message."""
    ...
    expanded: OptionalNullable[List[AppResourceServiceUpdateResponseExpanded]] = UNSET
    r"""The expanded field."""
