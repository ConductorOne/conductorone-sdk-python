...
class ApprovedActionTypedDict(TypedDict):
    ...
    r"""The ID of the step-up transaction that was used for this approval, if step-up was required."""
...
class ApprovedAction(BaseModel):
    ...
    approved_at: Annotated[Optional[datetime], pydantic.Field(alias="approvedAt")] = (
        None
    )
