...
from .unconfiguredprovision import UnconfiguredProvision, UnconfiguredProvisionTypedDict
...
class ProvisionPolicyInputTypedDict(TypedDict):
    ...
    action_provision: NotRequired[Nullable[ActionProvisionTypedDict]]
    ...
    unconfigured_provision: NotRequired[Nullable[UnconfiguredProvisionTypedDict]]
...
class ProvisionPolicyInput(BaseModel):
    r"""ProvisionPolicy is a oneOf that indicates how a provision step should be processed.
    ...
    action_provision: Annotated[
        OptionalNullable[ActionProvision], pydantic.Field(alias="action")
    ] = UNSET
    r"""This provision step indicates that account lifecycle action should be called to provision this entitlement."""

    connector_provision: Annotated[
        OptionalNullable[ConnectorProvision], pydantic.Field(alias="connector")
    ] = UNSET
    r"""Indicates that a connector should perform the provisioning. This object has no fields.
    ...
    delegated_provision: Annotated[
        OptionalNullable[DelegatedProvision], pydantic.Field(alias="delegated")
    ] = UNSET
    r"""This provision step indicates that we should delegate provisioning to the configuration of another app entitlement. This app entitlement does not have to be one from the same app, but MUST be configured as a proxy binding leading into this entitlement."""

    external_ticket_provision: Annotated[
        OptionalNullable[ExternalTicketProvision],
        pydantic.Field(alias="externalTicket"),
    ] = UNSET
    r"""This provision step indicates that we should check an external ticket to provision this entitlement"""

    manual_provision: Annotated[
        OptionalNullable[ManualProvision], pydantic.Field(alias="manual")
    ] = UNSET
    r"""Manual provisioning indicates that a human must intervene for the provisioning of this step."""

    multi_step: Annotated[
        OptionalNullable[MultiStep], pydantic.Field(alias="multiStep")
    ] = UNSET
    r"""MultiStep indicates that this provision step has multiple steps to process."""

    unconfigured_provision: Annotated[
        OptionalNullable[UnconfiguredProvision], pydantic.Field(alias="unconfigured")
    ] = UNSET
    r"""The UnconfiguredProvision message."""

    webhook_provision: Annotated[
        OptionalNullable[WebhookProvision], pydantic.Field(alias="webhook")
    ] = UNSET
    r"""This provision step indicates that a webhook should be called to provision this entitlement."""
