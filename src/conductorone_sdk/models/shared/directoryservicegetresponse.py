...
class DirectoryServiceGetResponseExpandedTypedDict(TypedDict):
...
class DirectoryServiceGetResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class DirectoryServiceGetResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[Nullable[List[DirectoryServiceGetResponseExpandedTypedDict]]]
...
class DirectoryServiceGetResponse(BaseModel):
    ...
    expanded: OptionalNullable[List[DirectoryServiceGetResponseExpanded]] = UNSET
    r"""List of serialized related objects."""
