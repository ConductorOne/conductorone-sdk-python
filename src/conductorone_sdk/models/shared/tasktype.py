...
from .tasktypeaction import TaskTypeAction, TaskTypeActionTypedDict
...
class TaskTypeTypedDict(TypedDict):
    ...
    task_type_action: NotRequired[Nullable[TaskTypeActionTypedDict]]
...
class TaskType(BaseModel):
    ...
    task_type_action: Annotated[
        OptionalNullable[TaskTypeAction], pydantic.Field(alias="action")
    ] = UNSET
    r"""The TaskTypeAction message."""
