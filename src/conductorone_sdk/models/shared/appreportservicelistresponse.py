...
from .apppopulationreport import AppPopulationReport, AppPopulationReportTypedDict
...
class AppReportServiceListResponseTypedDict(TypedDict):
    r"""The AppReportServiceListResponse message contains a list of results and a nextPageToken if applicable."""

    list: NotRequired[Nullable[List[AppPopulationReportTypedDict]]]
...
class AppReportServiceListResponse(BaseModel):
    r"""The AppReportServiceListResponse message contains a list of results and a nextPageToken if applicable."""

    list: OptionalNullable[List[AppPopulationReport]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request."""
