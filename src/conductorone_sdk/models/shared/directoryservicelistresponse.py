...
class DirectoryServiceListResponseExpandedTypedDict(TypedDict):
...
class DirectoryServiceListResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class DirectoryServiceListResponseTypedDict(TypedDict):
    r"""The DirectoryServiceListResponse message contains a list of results and a nextPageToken if applicable."""

    expanded: NotRequired[Nullable[List[DirectoryServiceListResponseExpandedTypedDict]]]
    ...
    """
    list: NotRequired[Nullable[List[DirectoryViewTypedDict]]]
...
class DirectoryServiceListResponse(BaseModel):
    r"""The DirectoryServiceListResponse message contains a list of results and a nextPageToken if applicable."""

    expanded: OptionalNullable[List[DirectoryServiceListResponseExpanded]] = UNSET
    r"""The nextPageToken is shown for the next page if the number of results is larger than the max page size.
    The server returns one page of results and the nextPageToken until all results are retreived.
    To retrieve the next page, use the same request and append a pageToken field with the value of nextPageToken shown on the previous page.
    """

    list: OptionalNullable[List[DirectoryView]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request."""
