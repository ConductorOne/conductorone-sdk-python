...
class FacetCategory(BaseModel):
    ...
    facet_range_item: Annotated[
        OptionalNullable[FacetRangeItem], pydantic.Field(alias="range")
    ] = UNSET
    r"""The FacetRangeItem message."""

    facet_value_item: Annotated[
        OptionalNullable[FacetValueItem], pydantic.Field(alias="value")
    ] = UNSET
    r"""The FacetValueItem message."""
