...
class AppEntitlementUserBindingHistoryViewTypedDict(TypedDict):
    ...
    app_entitlement_user_binding_history: NotRequired[
        AppEntitlementUserBindingHistoryTypedDict
    ]
...
class AppEntitlementUserBindingHistoryView(BaseModel):
    ...
    app_entitlement_user_binding_history: Annotated[
        Optional[AppEntitlementUserBindingHistory], pydantic.Field(alias="history")
    ] = None
    r"""The AppEntitlementUserBindingHistory message."""
