...
class ConnectorServiceCreateDelegatedRequestTypedDict(TypedDict):
    ...
    app_managed_state_binding_ref: NotRequired[AppManagedStateBindingRefTypedDict]
...
class ConnectorServiceCreateDelegatedRequest(BaseModel):
    ...
    app_managed_state_binding_ref: Annotated[
        Optional[AppManagedStateBindingRef],
        pydantic.Field(alias="appManagedStateBindingRef"),
    ] = None
    r"""The AppManagedStateBindingRef message."""
