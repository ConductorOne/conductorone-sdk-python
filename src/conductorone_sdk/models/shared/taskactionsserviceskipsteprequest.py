...
class TaskActionsServiceSkipStepRequestTypedDict(TypedDict):
    r"""The TaskActionsServiceSkipStepRequest object lets you skip a policy step in a task."""

    policy_step_id: str
    r"""The ID of the policy step to skip."""
...
class TaskActionsServiceSkipStepRequest(BaseModel):
    r"""The TaskActionsServiceSkipStepRequest object lets you skip a policy step in a task."""
