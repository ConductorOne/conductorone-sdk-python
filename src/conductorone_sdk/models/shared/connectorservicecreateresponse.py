...
class ConnectorServiceCreateResponseExpandedTypedDict(TypedDict):
...
class ConnectorServiceCreateResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class ConnectorServiceCreateResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[
        Nullable[List[ConnectorServiceCreateResponseExpandedTypedDict]]
    ]
    r"""The array of expanded items indicated by the request."""


class ConnectorServiceCreateResponse(BaseModel):
    r"""The ConnectorServiceCreateResponse is the response returned from creating a connector."""
    ...
    expanded: OptionalNullable[List[ConnectorServiceCreateResponseExpanded]] = UNSET
    r"""The array of expanded items indicated by the request."""
