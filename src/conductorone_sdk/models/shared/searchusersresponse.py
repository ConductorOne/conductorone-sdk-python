...
class SearchUsersResponseExpandedTypedDict(TypedDict):
...
class SearchUsersResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class SearchUsersResponseTypedDict(TypedDict):
    r"""The SearchUsersResponse message."""

    expanded: NotRequired[Nullable[List[SearchUsersResponseExpandedTypedDict]]]
...
class SearchUsersResponse(BaseModel):
    ...
    expanded: OptionalNullable[List[SearchUsersResponseExpanded]] = UNSET
    r"""List of related objects"""
