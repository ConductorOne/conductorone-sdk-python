...
class AppEntitlementSearchServiceSearchResponseExpandedTypedDict(TypedDict):
...
class AppEntitlementSearchServiceSearchResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class AppEntitlementSearchServiceSearchResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[
        Nullable[List[AppEntitlementSearchServiceSearchResponseExpandedTypedDict]]
    ]
...
class AppEntitlementSearchServiceSearchResponse(BaseModel):
    ...
    expanded: OptionalNullable[
        List[AppEntitlementSearchServiceSearchResponseExpanded]
    ] = UNSET
    r"""List of related objects."""
