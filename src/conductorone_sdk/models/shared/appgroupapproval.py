...
class AppGroupApprovalTypedDict(TypedDict):
    ...
    fallback_group_ids: NotRequired[Nullable[List[AppEntitlementReferenceTypedDict]]]
    r"""Configuration to specify which groups to fallback to if fallback is enabled and the group is empty."""
...
class AppGroupApproval(BaseModel):
    ...
    fallback_group_ids: Annotated[
        OptionalNullable[List[AppEntitlementReference]],
        pydantic.Field(alias="fallbackGroupIds"),
    ] = UNSET
    r"""Configuration to specify which groups to fallback to if fallback is enabled and the group is empty."""
    ...
    is_group_fallback_enabled: Annotated[
        Optional[bool], pydantic.Field(alias="isGroupFallbackEnabled")
    ] = None
    r"""Configuration to enable fallback for group fallback."""
