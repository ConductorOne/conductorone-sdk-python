...
class AppResourceTypeServiceGetResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[
        Nullable[List[AppResourceTypeServiceGetResponseExpandedTypedDict]]
    ]
...
class AppResourceTypeServiceGetResponse(BaseModel):
    ...
    app_resource_type_view: Annotated[
        Optional[AppResourceTypeView], pydantic.Field(alias="appResourceTypeView")
    ] = None
    r"""The AppResourceTypeView message."""
