...
class RequestCatalogManagementServiceAddAccessEntitlementsRequestTypedDict(TypedDict):
    ...
    access_entitlements: Nullable[List[AppEntitlementRefTypedDict]]
...
class RequestCatalogManagementServiceAddAccessEntitlementsRequest(BaseModel):
    ...
    access_entitlements: Annotated[
        Nullable[List[AppEntitlementRef]], pydantic.Field(alias="accessEntitlements")
    ]
    r"""List of entitlements to add to the request catalog as access entitlements."""
