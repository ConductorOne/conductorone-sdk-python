...
class PolicyStepInputTypedDict(TypedDict):
    ...
    """
    form: NotRequired[Nullable[FormInput1TypedDict]]
    r"""The Form message."""
...
class PolicyStepInput(BaseModel):
    r"""The PolicyStep message.
    ...
    form: OptionalNullable[FormInput1] = UNSET
    r"""The Form message."""
