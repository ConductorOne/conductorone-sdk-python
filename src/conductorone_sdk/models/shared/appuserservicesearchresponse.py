...
class AppUserServiceSearchResponseExpandedTypedDict(TypedDict):
...
class AppUserServiceSearchResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class AppUserServiceSearchResponseTypedDict(TypedDict):
    r"""The AppUserServiceSearchResponse message."""

    expanded: NotRequired[Nullable[List[AppUserServiceSearchResponseExpandedTypedDict]]]
...
class AppUserServiceSearchResponse(BaseModel):
    r"""The AppUserServiceSearchResponse message."""

    expanded: OptionalNullable[List[AppUserServiceSearchResponseExpanded]] = UNSET
    r"""List of related objects."""
