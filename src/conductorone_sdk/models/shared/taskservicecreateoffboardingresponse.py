...
class TaskServiceCreateOffboardingResponseExpandedTypedDict(TypedDict):
...
class TaskServiceCreateOffboardingResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class TaskServiceCreateOffboardingResponseTypedDict(TypedDict):
    r"""The TaskServiceCreateOffboardingResponse message."""
    ...
    expanded: NotRequired[
        Nullable[List[TaskServiceCreateOffboardingResponseExpandedTypedDict]]
    ]
    r"""The expanded field."""


class TaskServiceCreateOffboardingResponse(BaseModel):
    r"""The TaskServiceCreateOffboardingResponse message."""

    task_view: Annotated[Optional[TaskView], pydantic.Field(alias="taskView")] = None
    r"""Contains a task and JSONPATH expressions that describe where in the expanded array related objects are located. This view can be used to display a fully-detailed dashboard of task information."""

    expanded: OptionalNullable[List[TaskServiceCreateOffboardingResponseExpanded]] = (
        UNSET
    )
    r"""The expanded field."""
