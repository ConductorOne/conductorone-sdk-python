...
class ConnectorViewTypedDict(TypedDict):
    ...
    capabilities_path: NotRequired[str]
    r"""JSONPATH expression indicating the location of the ConnectorCapabilities object in the expanded array."""
...
class ConnectorView(BaseModel):
    ...
    capabilities_path: Annotated[
        Optional[str], pydantic.Field(alias="capabilitiesPath")
    ] = None
    r"""JSONPATH expression indicating the location of the ConnectorCapabilities object in the expanded array."""
