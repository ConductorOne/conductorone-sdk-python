...
class GrantedStatus(str, Enum, metaclass=utils.OpenEnumMeta):
...
class RequestCatalogSearchServiceSearchEntitlementsRequest(BaseModel):
    ...
    app_display_name: Annotated[
        Optional[str], pydantic.Field(alias="appDisplayName")
    ] = None
    r"""Search entitlements that belong to this app name (exact match)."""

    entitlement_alias: Annotated[
        Optional[str], pydantic.Field(alias="entitlementAlias")
    ] = None
    r"""Search for entitlements with this alias (exact match)."""

    granted_status: Annotated[
        Annotated[Optional[GrantedStatus], PlainValidator(validate_open_enum(False))],
        pydantic.Field(alias="grantedStatus"),
    ] = None
    r"""Search entitlements with this granted status for your signed in user."""
