...
class CreateManuallyManagedResourceTypeResponseExpandedTypedDict(TypedDict):
...
class CreateManuallyManagedResourceTypeResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class CreateManuallyManagedResourceTypeResponseTypedDict(TypedDict):
    r"""The CreateManuallyManagedResourceTypeResponse message."""
    ...
    expanded: NotRequired[
        Nullable[List[CreateManuallyManagedResourceTypeResponseExpandedTypedDict]]
    ]
    r"""The expanded field."""


class CreateManuallyManagedResourceTypeResponse(BaseModel):
    r"""The CreateManuallyManagedResourceTypeResponse message."""
    ...
    expanded: OptionalNullable[
        List[CreateManuallyManagedResourceTypeResponseExpanded]
    ] = UNSET
    r"""The expanded field."""
