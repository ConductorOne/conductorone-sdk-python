...
class ExportServiceCreateRequestTypedDict(TypedDict):
    r"""The ExportServiceCreateRequest message is used to create a new system log exporter.
...
class ExportServiceCreateRequest(BaseModel):
    r"""The ExportServiceCreateRequest message is used to create a new system log exporter.
