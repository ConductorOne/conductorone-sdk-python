...
class AppUserType(str, Enum, metaclass=utils.OpenEnumMeta):
...
class AppUserTypedDict(TypedDict):
    ...
    r"""The employee IDs field of the application user."""
    id: NotRequired[str]
...
class AppUser(BaseModel):
    ...
    app_user_status: Annotated[
        Optional[AppUserStatus], pydantic.Field(alias="status")
    ] = None
    r"""The satus of the applicaiton user."""
    ...
    app_user_type: Annotated[
        Annotated[Optional[AppUserType], PlainValidator(validate_open_enum(False))],
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = ["emails", "employeeIds", "usernames"]
        null_default_fields = []
...
class AppUserInput(BaseModel):
    ...
    app_user_status: Annotated[
        Optional[AppUserStatusInput], pydantic.Field(alias="status")
    ] = None
    r"""The satus of the applicaiton user."""
