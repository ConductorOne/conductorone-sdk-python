...
class TaskActionsServiceCloseRequestTypedDict(TypedDict):
    r"""The TaskActionsServiceCloseRequest object lets you close or cancel a task."""
...
class TaskActionsServiceCloseRequest(BaseModel):
    r"""The TaskActionsServiceCloseRequest object lets you close or cancel a task."""
