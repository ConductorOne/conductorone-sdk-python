...
class ConnectorServiceListResponseExpandedTypedDict(TypedDict):
...
class ConnectorServiceListResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class ConnectorServiceListResponseTypedDict(TypedDict):
    r"""The ConnectorServiceListResponse message contains a list of results and a nextPageToken if applicable"""

    expanded: NotRequired[Nullable[List[ConnectorServiceListResponseExpandedTypedDict]]]
    r"""List of serialized related objects"""
    list: NotRequired[Nullable[List[ConnectorViewTypedDict]]]
...
class ConnectorServiceListResponse(BaseModel):
    r"""The ConnectorServiceListResponse message contains a list of results and a nextPageToken if applicable"""

    expanded: OptionalNullable[List[ConnectorServiceListResponseExpanded]] = UNSET
    r"""List of serialized related objects"""

    list: OptionalNullable[List[ConnectorView]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request"""
