...
class UserServiceGetResponseExpandedTypedDict(TypedDict):
...
class UserServiceGetResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class UserServiceGetResponseTypedDict(TypedDict):
    ...
    user_view: NotRequired[UserViewTypedDict]
    r"""The UserView object provides a user response object, as well as JSONPATHs to related objects provided by expanders."""
    expanded: NotRequired[Nullable[List[UserServiceGetResponseExpandedTypedDict]]]
    r"""List of serialized related objects."""


class UserServiceGetResponse(BaseModel):
    r"""The UserServiceGetResponse returns a user view which has a user including JSONPATHs to the expanded items in the expanded array."""

    user_view: Annotated[Optional[UserView], pydantic.Field(alias="userView")] = None
    r"""The UserView object provides a user response object, as well as JSONPATHs to related objects provided by expanders."""

    expanded: OptionalNullable[List[UserServiceGetResponseExpanded]] = UNSET
    r"""List of serialized related objects."""

    @model_serializer(mode="wrap")
    def serialize_model(self, handler):
        optional_fields = ["UserView", "expanded"]
