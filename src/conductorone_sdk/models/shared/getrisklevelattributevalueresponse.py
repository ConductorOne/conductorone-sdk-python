...
class GetRiskLevelAttributeValueResponseTypedDict(TypedDict):
    r"""The GetRiskLevelAttributeValueResponse message."""

    attribute_value: NotRequired[AttributeValueTypedDict]
    r"""AttributeValue is the value of an attribute of a defined type."""


class GetRiskLevelAttributeValueResponse(BaseModel):
    r"""The GetRiskLevelAttributeValueResponse message."""
