...
class FunctionsServiceInvokeRequestTypedDict(TypedDict):
    r"""The FunctionsServiceInvokeRequest message.
...
class FunctionsServiceInvokeRequest(BaseModel):
    r"""The FunctionsServiceInvokeRequest message.
