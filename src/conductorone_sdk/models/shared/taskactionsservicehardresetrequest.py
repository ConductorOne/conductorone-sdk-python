...
class TaskActionsServiceHardResetRequestTypedDict(TypedDict):
    r"""The TaskActionsServiceHardResetRequest object lets you reset a task and recalculate its policy."""
...
class TaskActionsServiceHardResetRequest(BaseModel):
    r"""The TaskActionsServiceHardResetRequest object lets you reset a task and recalculate its policy."""
