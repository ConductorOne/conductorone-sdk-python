...
class TaskRevokeSourceTypedDict(TypedDict):
    ...
    task_revoke_source_non_usage: NotRequired[
        Nullable[TaskRevokeSourceNonUsageTypedDict]
    ]
...
class TaskRevokeSource(BaseModel):
    ...
    task_revoke_source_expired: Annotated[
        OptionalNullable[TaskRevokeSourceExpired], pydantic.Field(alias="expired")
    ] = UNSET
    r"""The TaskRevokeSourceExpired message indicates that the source of the revoke task is due to a grant expiring."""

    task_revoke_source_non_usage: Annotated[
        OptionalNullable[TaskRevokeSourceNonUsage], pydantic.Field(alias="nonUsage")
    ] = UNSET
    r"""The TaskRevokeSourceNonUsage message indicates that the source of the revoke task is due to the grant not being used."""

    task_revoke_source_request: Annotated[
        OptionalNullable[TaskRevokeSourceRequest], pydantic.Field(alias="request")
    ] = UNSET
    r"""The TaskRevokeSourceRequest message indicates that the source of the revoke task was a request."""

    task_revoke_source_review: Annotated[
        OptionalNullable[TaskRevokeSourceReview], pydantic.Field(alias="review")
    ] = UNSET
    r"""The TaskRevokeSourceReview message tracks which access review was the source of the specificed revoke ticket."""
