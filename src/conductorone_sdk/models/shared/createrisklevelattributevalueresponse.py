...
class CreateRiskLevelAttributeValueResponseTypedDict(TypedDict):
    r"""The CreateRiskLevelAttributeValueResponse message."""

    attribute_value: NotRequired[AttributeValueTypedDict]
    r"""AttributeValue is the value of an attribute of a defined type."""


class CreateRiskLevelAttributeValueResponse(BaseModel):
    r"""The CreateRiskLevelAttributeValueResponse message."""
