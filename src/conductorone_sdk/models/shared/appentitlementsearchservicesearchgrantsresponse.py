...
class AppEntitlementSearchServiceSearchGrantsResponseTypedDict(TypedDict):
    r"""The AppEntitlementSearchServiceSearchGrantsResponse message."""

    expanded: NotRequired[Nullable[List[ExpandedTypedDict]]]
    r"""The expanded field."""
    list: NotRequired[Nullable[List[AppEntitlementWithUserBindingTypedDict]]]
    r"""The list field."""
    next_page_token: NotRequired[str]
    r"""The nextPageToken field."""


class AppEntitlementSearchServiceSearchGrantsResponse(BaseModel):
    r"""The AppEntitlementSearchServiceSearchGrantsResponse message."""

    expanded: OptionalNullable[List[Expanded]] = UNSET
    r"""The expanded field."""

    list: OptionalNullable[List[AppEntitlementWithUserBinding]] = UNSET
    r"""The list field."""
