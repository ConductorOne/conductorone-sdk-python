...
class ConnectorTypedDict(TypedDict):
    ...
    disable_check_bad_sync: NotRequired[bool]
    r"""The disableCheckBadSync field."""
    ...
    profile_allow_list: NotRequired[Nullable[List[str]]]
    r"""List of profile attributes to sync, when set only these attributes will be synced"""
    profile_ignore_list: NotRequired[Nullable[List[str]]]
    r"""List of profile attributes to ignore (not sync), when set other attributes will be synced, but these will not."""
    sync_disabled_at: NotRequired[datetime]
    sync_disabled_category: NotRequired[str]
    r"""The category of the connector sync that was disabled."""
    sync_disabled_reason: NotRequired[str]
    r"""The reason the connector sync was disabled."""
...
class Connector(BaseModel):
    ...
    connector_status: Annotated[
        Optional[ConnectorStatus], pydantic.Field(alias="status")
    ] = None
    r"""The status field on the connector is used to track the status of the connectors sync, and when syncing last started, completed, or caused the connector to update."""

    o_auth2_authorized_as: Annotated[
    ...
    can_resume_sync: Annotated[
        Optional[bool], pydantic.Field(alias="canResumeSync")
    ] = None
    r"""The canResumeSync field."""
    ...
    disable_check_bad_sync: Annotated[
        Optional[bool], pydantic.Field(alias="disableCheckBadSync")
    ] = None
    r"""The disableCheckBadSync field."""
    ...
    profile_allow_list: Annotated[
        OptionalNullable[List[str]], pydantic.Field(alias="profileAllowList")
    ] = UNSET
    r"""List of profile attributes to sync, when set only these attributes will be synced"""

    profile_ignore_list: Annotated[
        OptionalNullable[List[str]], pydantic.Field(alias="profileIgnoreList")
    ] = UNSET
    r"""List of profile attributes to ignore (not sync), when set other attributes will be synced, but these will not."""

    sync_disabled_at: Annotated[
        Optional[datetime], pydantic.Field(alias="syncDisabledAt")
    ] = None

    sync_disabled_category: Annotated[
        Optional[str], pydantic.Field(alias="syncDisabledCategory")
    ] = None
    r"""The category of the connector sync that was disabled."""

    sync_disabled_reason: Annotated[
        Optional[str], pydantic.Field(alias="syncDisabledReason")
    ] = None
    r"""The reason the connector sync was disabled."""
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = ["profileAllowList", "profileIgnoreList", "userIds"]
        null_default_fields = []
