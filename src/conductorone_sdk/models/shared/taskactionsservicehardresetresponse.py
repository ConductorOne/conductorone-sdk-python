...
class TaskActionsServiceHardResetResponseExpandedTypedDict(TypedDict):
...
class TaskActionsServiceHardResetResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class TaskActionsServiceHardResetResponseTypedDict(TypedDict):
    r"""The TaskActionsServiceHardResetResponse message."""
    ...
    expanded: NotRequired[
        Nullable[List[TaskActionsServiceHardResetResponseExpandedTypedDict]]
    ]
...
class TaskActionsServiceHardResetResponse(BaseModel):
    r"""The TaskActionsServiceHardResetResponse message."""

    task_view: Annotated[Optional[TaskView], pydantic.Field(alias="taskView")] = None
    r"""Contains a task and JSONPATH expressions that describe where in the expanded array related objects are located. This view can be used to display a fully-detailed dashboard of task information."""

    expanded: OptionalNullable[List[TaskActionsServiceHardResetResponseExpanded]] = (
        UNSET
    )
    r"""The expanded field."""
