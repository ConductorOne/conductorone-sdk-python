...
class AppResourceServiceListResponseExpandedTypedDict(TypedDict):
...
class AppResourceServiceListResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class AppResourceServiceListResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[
        Nullable[List[AppResourceServiceListResponseExpandedTypedDict]]
    ]
...
class AppResourceServiceListResponse(BaseModel):
    r"""The AppResourceServiceListResponse message contains a list of results and a nextPageToken if applicable."""

    expanded: OptionalNullable[List[AppResourceServiceListResponseExpanded]] = UNSET
    r"""List of serialized related objects."""
