...
class TaskActionsServiceUpdateGrantDurationRequestTypedDict(TypedDict):
    r"""The TaskActionsServiceUpdateGrantDurationRequest message."""
...
class TaskActionsServiceUpdateGrantDurationRequest(BaseModel):
    r"""The TaskActionsServiceUpdateGrantDurationRequest message."""
