...
class RequestCatalogManagementServiceListResponseExpandedTypedDict(TypedDict):
...
class RequestCatalogManagementServiceListResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class RequestCatalogManagementServiceListResponseTypedDict(TypedDict):
    r"""The RequestCatalogManagementServiceListResponse message."""

    expanded: NotRequired[
        Nullable[List[RequestCatalogManagementServiceListResponseExpandedTypedDict]]
    ]
    r"""List of serialized related objects."""
    list: NotRequired[Nullable[List[RequestCatalogViewTypedDict]]]
...
class RequestCatalogManagementServiceListResponse(BaseModel):
    r"""The RequestCatalogManagementServiceListResponse message."""

    expanded: OptionalNullable[
        List[RequestCatalogManagementServiceListResponseExpanded]
    ] = UNSET
    r"""List of serialized related objects."""

    list: OptionalNullable[List[RequestCatalogView]] = UNSET
    r"""The list of request catalogs."""
