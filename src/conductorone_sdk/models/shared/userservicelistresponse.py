...
class UserServiceListResponseExpandedTypedDict(TypedDict):
...
class UserServiceListResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class UserServiceListResponseTypedDict(TypedDict):
    r"""The UserServiceListResponse message contains a list of results and a nextPageToken if applicable."""

    expanded: NotRequired[Nullable[List[UserServiceListResponseExpandedTypedDict]]]
    r"""List of serialized related objects."""
    list: NotRequired[Nullable[List[UserViewTypedDict]]]
...
class UserServiceListResponse(BaseModel):
    ...
    expanded: OptionalNullable[List[UserServiceListResponseExpanded]] = UNSET
    r"""List of serialized related objects."""

    list: OptionalNullable[List[UserView]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request"""
