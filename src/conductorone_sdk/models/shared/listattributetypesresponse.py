...
class ListAttributeTypesResponseTypedDict(TypedDict):
    r"""ListAttributeTypesResponse is the response for listing attribute types."""

    list: NotRequired[Nullable[List[AttributeTypeTypedDict]]]
...
class ListAttributeTypesResponse(BaseModel):
    r"""ListAttributeTypesResponse is the response for listing attribute types."""

    list: OptionalNullable[List[AttributeType]] = UNSET
    r"""The list of AttributeTypes."""
