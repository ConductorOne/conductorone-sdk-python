...
class RequestCatalogManagementServiceListEntitlementsForAccessResponseExpandedTypedDict(
    TypedDict
):
...
class RequestCatalogManagementServiceListEntitlementsForAccessResponseTypedDict(
    TypedDict
):
...
class RequestCatalogManagementServiceListEntitlementsForAccessResponse(BaseModel):
    ...
    expanded: OptionalNullable[
        List[RequestCatalogManagementServiceListEntitlementsForAccessResponseExpanded]
    ] = UNSET
    r"""List of serialized related objects."""
