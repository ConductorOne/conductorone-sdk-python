...
from conductorone_sdk.models.shared import (
    taskactionsservicedenyrequest as shared_taskactionsservicedenyrequest,
    taskactionsservicedenyresponse as shared_taskactionsservicedenyresponse,
)
...
class C1APITaskV1TaskActionsServiceDenyResponseTypedDict(TypedDict):
    ...
    task_actions_service_deny_response: NotRequired[
        shared_taskactionsservicedenyresponse.TaskActionsServiceDenyResponseTypedDict
    ]
...
class C1APITaskV1TaskActionsServiceDenyResponse(BaseModel):
    ...
    task_actions_service_deny_response: Optional[
        shared_taskactionsservicedenyresponse.TaskActionsServiceDenyResponse
    ] = None
    r"""The TaskActionsServiceDenyResponse returns a task view with paths indicating the location of expanded items in the array."""
