        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="c1.api.settings.v1.SessionSettingsService.Get",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APISettingsV1SessionSettingsServiceGetResponse(
                get_session_settings_response=unmarshal_json_response(
                    Optional[shared.GetSessionSettingsResponse], http_res
                ),
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="c1.api.settings.v1.SessionSettingsService.TestSourceIP",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APISettingsV1SessionSettingsServiceTestSourceIPResponse(
                test_source_ip_response=unmarshal_json_response(
                    Optional[shared.TestSourceIPResponse], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="c1.api.settings.v1.SessionSettingsService.Update",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APISettingsV1SessionSettingsServiceUpdateResponse(
                update_session_settings_response=unmarshal_json_response(
                    Optional[shared.UpdateSessionSettingsResponse], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
