...
class AccessConflict(BaseSDK):
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="c1.api.accessconflict.v1.AccessConflictService.CreateMonitor",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAccessconflictV1AccessConflictServiceCreateMonitorResponse(
                conflict_monitor=unmarshal_json_response(
                    Optional[shared.ConflictMonitor], http_res
                ),
    ...
    def delete_monitor(
        ...
        *,
        request: Union[
            ...
            operations.C1APIAccessconflictV1AccessConflictServiceDeleteMonitorRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="c1.api.accessconflict.v1.AccessConflictService.DeleteMonitor",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAccessconflictV1AccessConflictServiceDeleteMonitorResponse(
                conflict_monitor_delete_response=unmarshal_json_response(
                    Optional[shared.ConflictMonitorDeleteResponse], http_res
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
    ...
    async def delete_monitor_async(
        self,
        *,
        request: Union[
            operations.C1APIAccessconflictV1AccessConflictServiceDeleteMonitorRequest,
    ...
    def get_monitor(
        ...
        *,
        request: Union[
            ...
            operations.C1APIAccessconflictV1AccessConflictServiceGetMonitorRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="c1.api.accessconflict.v1.AccessConflictService.GetMonitor",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
    ...
    def update_monitor(
        ...
        *,
        request: Union[
            ...
            operations.C1APIAccessconflictV1AccessConflictServiceUpdateMonitorRequestTypedDict,
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="c1.api.accessconflict.v1.AccessConflictService.UpdateMonitor",
                oauth2_scopes=None,
                security_source=self.sdk_configuration.security,
            ),
            request=req,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAccessconflictV1AccessConflictServiceUpdateMonitorResponse(
                conflict_monitor=unmarshal_json_response(
                    Optional[shared.ConflictMonitor], http_res
                ),
                status_code=http_res.status_code,
