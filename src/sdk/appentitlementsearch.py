...
class AppEntitlementSearch:
    ...
    def search(self, request: Optional[shared.AppEntitlementSearchServiceSearchRequest]) -> operations.C1APIAppV1AppEntitlementSearchServiceSearchResponse:
        ...
        res = operations.C1APIAppV1AppEntitlementSearchServiceSearchResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
