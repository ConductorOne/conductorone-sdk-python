...
class TaskSearch:
    ...
    def search(self, request: Optional[shared.TaskSearchRequest] = None) -> operations.C1APITaskV1TaskSearchServiceSearchResponse:
        r"""Search
        ...
        res = operations.C1APITaskV1TaskSearchServiceSearchResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
