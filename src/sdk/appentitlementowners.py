...
class AppEntitlementOwners:
    ...
    def add(self, request: operations.C1APIAppV1AppEntitlementOwnersAddRequest) -> operations.C1APIAppV1AppEntitlementOwnersAddResponse:
        ...
        url = utils.generate_url(base_url, '/api/v1/apps/{app_id}/entitlements/{entitlement_id}/owners', request)
        ...
        res = operations.C1APIAppV1AppEntitlementOwnersAddResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def list(self, request: operations.C1APIAppV1AppEntitlementOwnersListRequest) -> operations.C1APIAppV1AppEntitlementOwnersListResponse:
        ...
        res = operations.C1APIAppV1AppEntitlementOwnersListResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def remove(self, request: operations.C1APIAppV1AppEntitlementOwnersRemoveRequest) -> operations.C1APIAppV1AppEntitlementOwnersRemoveResponse:
        ...
        url = utils.generate_url(base_url, '/api/v1/apps/{app_id}/entitlements/{entitlement_id}/owners/{user_id}', request)
        ...
        res = operations.C1APIAppV1AppEntitlementOwnersRemoveResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def set(self, request: operations.C1APIAppV1AppEntitlementOwnersSetRequest) -> operations.C1APIAppV1AppEntitlementOwnersSetResponse:
        ...
        res = operations.C1APIAppV1AppEntitlementOwnersSetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
