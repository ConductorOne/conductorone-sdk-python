...
class AppUser:
    ...
    def update(self, request: operations.C1APIAppV1AppUserServiceUpdateRequest) -> operations.C1APIAppV1AppUserServiceUpdateResponse:
        ...
        res = operations.C1APIAppV1AppUserServiceUpdateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
