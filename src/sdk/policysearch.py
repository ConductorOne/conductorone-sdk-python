...
class PolicySearch:
    ...
    def search(self, request: Optional[shared.SearchPoliciesRequest]) -> operations.C1APIPolicyV1PolicySearchSearchResponse:
        ...
        res = operations.C1APIPolicyV1PolicySearchSearchResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
