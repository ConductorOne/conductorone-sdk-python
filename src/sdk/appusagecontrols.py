...
class AppUsageControls:
    ...
    def get(self, request: operations.C1APIAppV1AppUsageControlsServiceGetRequest) -> operations.C1APIAppV1AppUsageControlsServiceGetResponse:
        ...
        res = operations.C1APIAppV1AppUsageControlsServiceGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, request: operations.C1APIAppV1AppUsageControlsServiceUpdateRequest) -> operations.C1APIAppV1AppUsageControlsServiceUpdateResponse:
        ...
        res = operations.C1APIAppV1AppUsageControlsServiceUpdateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
