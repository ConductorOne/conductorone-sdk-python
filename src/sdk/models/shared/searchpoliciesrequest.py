...
class SearchPoliciesRequest:
    ...
    policy_types: Optional[list[SearchPoliciesRequestPolicyTypes]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('policyTypes'), 'exclude': lambda f: f is None }})
    ...
    refs: Optional[list[shared_policyref.PolicyRef]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('refs'), 'exclude': lambda f: f is None }})
    r"""The refs field."""
