...
import dataclasses
from .apppopulationreport import AppPopulationReport
...
class AppReportServiceListResponse:
    ...
    list: Optional[List[AppPopulationReport]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is AppReportServiceListResponse.UNSET }})
