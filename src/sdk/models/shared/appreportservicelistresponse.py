...
import dataclasses
from ..shared import apppopulationreport as shared_apppopulationreport
...
class AppReportServiceListResponse:
    r"""The AppReportServiceListResponse message contains a list of results and a nextPageToken if applicable."""
    list_: Optional[list[shared_apppopulationreport.AppPopulationReport]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is None }})
