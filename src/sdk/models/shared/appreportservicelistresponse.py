...
class AppReportServiceListResponse:
    ...
    list_: Optional[list[shared_apppopulationreport.AppPopulationReport]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
