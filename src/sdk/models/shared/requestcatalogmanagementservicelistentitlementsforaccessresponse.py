...
class RequestCatalogManagementServiceListEntitlementsForAccessResponse:
    ...
    expanded: Optional[List[RequestCatalogManagementServiceListEntitlementsForAccessResponseExpanded]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded') }})
