...
class RequestCatalogManagementServiceListEntitlementsForAccessResponseExpandedTypedDict(TypedDict):
...
class RequestCatalogManagementServiceListEntitlementsForAccessResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class RequestCatalogManagementServiceListEntitlementsForAccessResponseTypedDict(TypedDict):
    ...
    expanded: NotRequired[Nullable[List[RequestCatalogManagementServiceListEntitlementsForAccessResponseExpandedTypedDict]]]
...
class RequestCatalogManagementServiceListEntitlementsForAccessResponse(BaseModel):
    r"""The RequestCatalogManagementServiceListEntitlementsForAccessResponse message contains a list of results and a nextPageToken if applicable."""
    
    expanded: OptionalNullable[List[RequestCatalogManagementServiceListEntitlementsForAccessResponseExpanded]] = UNSET
    r"""List of serialized related objects."""
