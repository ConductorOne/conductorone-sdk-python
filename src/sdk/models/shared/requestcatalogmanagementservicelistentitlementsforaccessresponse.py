...
class RequestCatalogManagementServiceListEntitlementsForAccessResponseExpanded:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class RequestCatalogManagementServiceListEntitlementsForAccessResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[RequestCatalogManagementServiceListEntitlementsForAccessResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is RequestCatalogManagementServiceListEntitlementsForAccessResponse.UNSET }})
    r"""List of serialized related objects."""
    list: Optional[List[AppEntitlementView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is RequestCatalogManagementServiceListEntitlementsForAccessResponse.UNSET }})
