...
class DirectoryView:
    ...
    directory: Optional[shared_directory.Directory] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('directory'), 'exclude': lambda f: f is None }})
