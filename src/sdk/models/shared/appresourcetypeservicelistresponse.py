...
class AppResourceTypeServiceListResponse:
    ...
    list_: Optional[list[shared_appresourcetypeview.AppResourceTypeView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is None }})
