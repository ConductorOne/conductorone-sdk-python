...
class ListAppResourceOwnersResponse:
    r"""The ListAppResourceOwnersResponse message contains a list of results and a nextPageToken if applicable"""
    UNSET='__SPEAKEASY_UNSET__'
    list: Optional[List[User]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is ListAppResourceOwnersResponse.UNSET }})
