...
class TaskSearchRequest(BaseModel):
    ...
    account_types: Annotated[
        OptionalNullable[List[AccountTypes]], pydantic.Field(alias="accountTypes")
    ] = UNSET
    r"""The accountTypes field."""
    ...
    current_step: Annotated[
        Optional[CurrentStep], pydantic.Field(alias="currentStep")
    ] = None
    r"""Search tasks that have this type of step as the current step."""

    emergency_status: Annotated[
        Optional[EmergencyStatus], pydantic.Field(alias="emergencyStatus")
    ] = None
    r"""Search tasks that are or are not emergency access."""
    ...
    task_states: Annotated[
        OptionalNullable[List[TaskStates]], pydantic.Field(alias="taskStates")
    ] = UNSET
    r"""Search tasks with this task state."""
