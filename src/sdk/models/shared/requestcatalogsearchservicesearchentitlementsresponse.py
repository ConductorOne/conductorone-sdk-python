...
import dataclasses
from .appentitlementwithuserbindings import AppEntitlementWithUserBindings
...
class RequestCatalogSearchServiceSearchEntitlementsResponseExpanded:
...
class RequestCatalogSearchServiceSearchEntitlementsResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[RequestCatalogSearchServiceSearchEntitlementsResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is RequestCatalogSearchServiceSearchEntitlementsResponse.UNSET }})
    r"""List of serialized related objects."""
    list: Optional[List[AppEntitlementWithUserBindings]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is RequestCatalogSearchServiceSearchEntitlementsResponse.UNSET }})
