...
import dataclasses
from ..shared import appentitlementwithuserbindings as shared_appentitlementwithuserbindings
...
class RequestCatalogSearchServiceSearchEntitlementsResponse:
    ...
    expanded: Optional[List[RequestCatalogSearchServiceSearchEntitlementsResponseExpanded]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded') }})
    r"""List of serialized related objects."""
    list: Optional[List[shared_appentitlementwithuserbindings.AppEntitlementWithUserBindings]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
