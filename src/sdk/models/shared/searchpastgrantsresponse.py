...
class SearchPastGrantsResponseExpandedTypedDict(TypedDict):
...
class SearchPastGrantsResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class SearchPastGrantsResponseTypedDict(TypedDict):
    r"""The SearchPastGrantsRequest message contains a list of results and a nextPageToken if applicable."""
    
    expanded: NotRequired[Nullable[List[SearchPastGrantsResponseExpandedTypedDict]]]
    r"""The expanded field."""
    list: NotRequired[Nullable[List[AppEntitlementUserBindingHistoryViewTypedDict]]]
...
class SearchPastGrantsResponse(BaseModel):
    r"""The SearchPastGrantsRequest message contains a list of results and a nextPageToken if applicable."""
    
    expanded: OptionalNullable[List[SearchPastGrantsResponseExpanded]] = UNSET
    r"""The expanded field."""
    list: OptionalNullable[List[AppEntitlementUserBindingHistoryView]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request."""
