...
class RequestCatalogManagementServiceListEntitlementsPerCatalogResponseExpanded:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class RequestCatalogManagementServiceListEntitlementsPerCatalogResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[RequestCatalogManagementServiceListEntitlementsPerCatalogResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is RequestCatalogManagementServiceListEntitlementsPerCatalogResponse.UNSET }})
    r"""List of serialized related objects."""
    list: Optional[List[AppEntitlementView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is RequestCatalogManagementServiceListEntitlementsPerCatalogResponse.UNSET }})
