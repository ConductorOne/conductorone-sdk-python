...
class ListAppEntitlementsResponseExpanded:
...
class ListAppEntitlementsResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[ListAppEntitlementsResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is ListAppEntitlementsResponse.UNSET }})
    r"""List of related objects"""
    list: Optional[List[AppEntitlementView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is ListAppEntitlementsResponse.UNSET }})
