...
class UserServiceListResponse:
    ...
    list_: Optional[list[shared_userview.UserView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is None }})
