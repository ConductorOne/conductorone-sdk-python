...
class UserServiceListResponse:
    ...
    expanded: Optional[List[UserServiceListResponseExpanded]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded') }})
    r"""List of serialized related objects."""
    list: Optional[List[UserView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
