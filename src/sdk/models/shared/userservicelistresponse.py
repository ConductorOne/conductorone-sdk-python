...
class UserServiceListResponseExpanded:
...
class UserServiceListResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[UserServiceListResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is UserServiceListResponse.UNSET }})
    r"""List of serialized related objects."""
    list: Optional[List[UserView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is UserServiceListResponse.UNSET }})
