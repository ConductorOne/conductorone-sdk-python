...
from .appentitlement import AppEntitlementInput1, AppEntitlementInput1TypedDict
import pydantic
...
class RequestCatalogInputTypedDict(TypedDict):
    ...
    access_entitlements: NotRequired[Nullable[List[AppEntitlementInput1TypedDict]]]
...
class RequestCatalogInput(BaseModel):
    ...
    access_entitlements: Annotated[
        OptionalNullable[List[AppEntitlementInput1]],
