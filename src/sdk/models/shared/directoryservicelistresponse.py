...
class DirectoryServiceListResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[DirectoryServiceListResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is DirectoryServiceListResponse.UNSET }})
    ...
    """
    list: Optional[List[DirectoryView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is DirectoryServiceListResponse.UNSET }})
