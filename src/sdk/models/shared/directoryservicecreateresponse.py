...
class DirectoryServiceCreateResponse:
    ...
    expanded: Optional[List[DirectoryServiceCreateResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is DirectoryServiceCreateResponse.UNSET }})
