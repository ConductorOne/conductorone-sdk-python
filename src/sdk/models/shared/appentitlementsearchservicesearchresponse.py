...
class AppEntitlementSearchServiceSearchResponse:
    ...
    expanded: Optional[List[Expanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is AppEntitlementSearchServiceSearchResponse.UNSET }})
    r"""List of related objects."""
    list: Optional[List[AppEntitlementView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is AppEntitlementSearchServiceSearchResponse.UNSET }})
