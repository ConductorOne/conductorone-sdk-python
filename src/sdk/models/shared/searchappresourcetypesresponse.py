...
class SearchAppResourceTypesResponse:
    ...
    list_: Optional[list[shared_appresourcetype.AppResourceType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
