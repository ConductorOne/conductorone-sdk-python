...
class SearchAppResourceTypesResponse:
    ...
    list: Optional[List[shared_appresourcetype.AppResourceType]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
