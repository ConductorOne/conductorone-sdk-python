...
class SearchAppResourceTypesResponse:
    ...
    list: Optional[List[AppResourceType]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is SearchAppResourceTypesResponse.UNSET }})
