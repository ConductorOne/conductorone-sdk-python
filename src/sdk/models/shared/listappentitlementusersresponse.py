...
import dataclasses
from ..shared import appentitlementuserview as shared_appentitlementuserview
...
class ListAppEntitlementUsersResponse:
    ...
    expanded: Optional[List[ListAppEntitlementUsersResponseExpanded]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded') }})
    r"""List of related objects"""
    list: Optional[List[shared_appentitlementuserview.AppEntitlementUserView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
