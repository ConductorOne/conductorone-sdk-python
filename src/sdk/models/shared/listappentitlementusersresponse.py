...
class ListAppEntitlementUsersResponse:
    ...
    list_: Optional[list[shared_appentitlementuserview.AppEntitlementUserView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
