...
class ListAppEntitlementUsersResponseExpandedTypedDict(TypedDict):
...
class ListAppEntitlementUsersResponseExpanded(BaseModel):
    r"""Contains an arbitrary serialized message along with a @type that describes the type of the serialized message."""
...
class ListAppEntitlementUsersResponseTypedDict(TypedDict):
    r"""The ListAppEntitlementUsersResponse message contains a list of results and a nextPageToken if applicable."""
    
    expanded: NotRequired[Nullable[List[ListAppEntitlementUsersResponseExpandedTypedDict]]]
    r"""List of related objects"""
    list: NotRequired[Nullable[List[AppEntitlementUserViewTypedDict]]]
...
class ListAppEntitlementUsersResponse(BaseModel):
    r"""The ListAppEntitlementUsersResponse message contains a list of results and a nextPageToken if applicable."""
    
    expanded: OptionalNullable[List[ListAppEntitlementUsersResponseExpanded]] = UNSET
    r"""List of related objects"""
    list: OptionalNullable[List[AppEntitlementUserView]] = UNSET
    r"""The list of results containing up to X results, where X is the page size defined in the request."""
