...
class TaskActionsServiceRestartResponseExpanded:
...
class TaskActionsServiceRestartResponse:
    ...
    expanded: Optional[List[TaskActionsServiceRestartResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is TaskActionsServiceRestartResponse.UNSET }})
