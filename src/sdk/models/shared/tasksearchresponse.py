...
class TaskSearchResponseExpanded:
...
class TaskSearchResponse:
    ...
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[TaskSearchResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is TaskSearchResponse.UNSET }})
    r"""The list of results containing up to X results, where X is the page size defined in the request."""
    list: Optional[List[TaskView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is TaskSearchResponse.UNSET }})
