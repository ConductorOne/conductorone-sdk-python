...
class ManagerApproval:
    ...
    assigned_user_ids: Optional[List[str]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('assignedUserIds'), 'exclude': lambda f: f is ManagerApproval.UNSET }})
    ...
    fallback_user_ids: Optional[List[str]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('fallbackUserIds'), 'exclude': lambda f: f is ManagerApproval.UNSET }})
