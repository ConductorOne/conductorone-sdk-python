...
class AppResourceServiceListResponse:
    ...
    expanded: Optional[List[AppResourceServiceListResponseExpanded]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded') }})
    r"""List of serialized related objects."""
    list: Optional[List[shared_appresourceview.AppResourceView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
