...
class AppResourceServiceListResponse:
    ...
    list_: Optional[list[shared_appresourceview.AppResourceView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
