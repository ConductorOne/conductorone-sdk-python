...
class TaskServiceCreateRevokeResponseExpanded:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class TaskServiceCreateRevokeResponse:
    ...
    expanded: Optional[List[TaskServiceCreateRevokeResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is TaskServiceCreateRevokeResponse.UNSET }})
