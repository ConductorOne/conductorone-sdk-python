...
class ConnectorServiceListResponse:
    ...
    list_: Optional[list[shared_connectorview.ConnectorView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is None }})
