...
class ConnectorServiceListResponse:
    ...
    expanded: Optional[List[ConnectorServiceListResponseExpanded]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded') }})
    r"""List of serialized related objects"""
    list: Optional[List[shared_connectorview.ConnectorView]] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list') }})
