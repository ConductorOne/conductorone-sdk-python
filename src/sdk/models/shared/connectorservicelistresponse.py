...
class ConnectorServiceListResponseExpanded:
...
@dataclass_json(undefined=Undefined.EXCLUDE)
@dataclasses.dataclass
class ConnectorServiceListResponse:
    r"""The ConnectorServiceListResponse message contains a list of results and a nextPageToken if applicable"""
    UNSET='__SPEAKEASY_UNSET__'
    expanded: Optional[List[ConnectorServiceListResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is ConnectorServiceListResponse.UNSET }})
    r"""List of serialized related objects"""
    list: Optional[List[ConnectorView]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('list'), 'exclude': lambda f: f is ConnectorServiceListResponse.UNSET }})
