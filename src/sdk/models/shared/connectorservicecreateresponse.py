...
class ConnectorServiceCreateResponseExpanded:
...
class ConnectorServiceCreateResponse:
    ...
    expanded: Optional[List[ConnectorServiceCreateResponseExpanded]] = dataclasses.field(default=UNSET, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('expanded'), 'exclude': lambda f: f is ConnectorServiceCreateResponse.UNSET }})
