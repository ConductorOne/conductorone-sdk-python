...
from sdk.models.shared import (
    connectorservicerotatecredentialrequest as shared_connectorservicerotatecredentialrequest,
...
class C1APIAppV1ConnectorServiceRotateCredentialRequestTypedDict(TypedDict):
    app_id: str
    connector_id: str
    connector_service_rotate_credential_request: NotRequired[
        shared_connectorservicerotatecredentialrequest.ConnectorServiceRotateCredentialRequestTypedDict
    ]
...
class C1APIAppV1ConnectorServiceRotateCredentialRequest(BaseModel):
    ...
    connector_service_rotate_credential_request: Annotated[
        Optional[
            shared_connectorservicerotatecredentialrequest.ConnectorServiceRotateCredentialRequest
        ],
