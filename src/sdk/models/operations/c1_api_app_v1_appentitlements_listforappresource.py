...
class C1APIAppV1AppEntitlementsListForAppResourceRequest:
    app_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'app_id', 'style': 'simple', 'explode': False }})
    app_resource_id: str = dataclasses.field(metadata={'path_param': { 'field_name': 'app_resource_id', 'style': 'simple', 'explode': False }})
...
@dataclasses.dataclass
class C1APIAppV1AppEntitlementsListForAppResourceResponse:
