        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAppV1AppsCreateResponse(
                create_app_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.CreateAppResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAppV1AppsDeleteResponse(
                delete_app_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.DeleteAppResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAppV1AppsGetResponse(
                get_app_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.GetAppResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAppV1AppsListResponse(
                list_apps_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.ListAppsResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIAppV1AppsUpdateResponse(
                update_app_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.UpdateAppResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
