...
class Apps:
    ...
    def create(self, request: Optional[shared.CreateAppRequest]) -> operations.C1APIAppV1AppsCreateResponse:
        r"""Create
        Create a new app.
        """
        ...
        res = operations.C1APIAppV1AppsCreateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete(self, request: operations.C1APIAppV1AppsDeleteRequest) -> operations.C1APIAppV1AppsDeleteResponse:
        ...
        res = operations.C1APIAppV1AppsDeleteResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get(self, request: operations.C1APIAppV1AppsGetRequest) -> operations.C1APIAppV1AppsGetResponse:
        ...
        res = operations.C1APIAppV1AppsGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list(self, request: operations.C1APIAppV1AppsListRequest) -> operations.C1APIAppV1AppsListResponse:
        ...
        query_params = { **utils.get_query_params(operations.C1APIAppV1AppsListRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.C1APIAppV1AppsListResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, request: operations.C1APIAppV1AppsUpdateRequest) -> operations.C1APIAppV1AppsUpdateResponse:
        ...
        res = operations.C1APIAppV1AppsUpdateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
