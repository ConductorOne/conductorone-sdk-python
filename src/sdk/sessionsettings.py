        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APISettingsV1SessionSettingsServiceGetResponse(
                get_session_settings_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.GetSessionSettingsResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APISettingsV1SessionSettingsServiceUpdateResponse(
                update_session_settings_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.UpdateSessionSettingsResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
