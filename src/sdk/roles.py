...
class Roles:
    ...
    def get(self, request: operations.C1APIIamV1RolesGetRequest) -> operations.C1APIIamV1RolesGetResponse:
        ...
        res = operations.C1APIIamV1RolesGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list(self, request: operations.C1APIIamV1RolesListRequest) -> operations.C1APIIamV1RolesListResponse:
        ...
        query_params = { **utils.get_query_params(operations.C1APIIamV1RolesListRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.C1APIIamV1RolesListResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, request: operations.C1APIIamV1RolesUpdateRequest) -> operations.C1APIIamV1RolesUpdateResponse:
        ...
        req_content_type, data, form = utils.serialize_request_body(request, operations.C1APIIamV1RolesUpdateRequest, "update_role_request", False, True, 'json')
        ...
        res = operations.C1APIIamV1RolesUpdateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
