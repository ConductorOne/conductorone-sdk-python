        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIIamV1RolesGetResponse(
                get_roles_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.GetRolesResponse]
                ),
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIIamV1RolesListResponse(
                list_roles_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.ListRolesResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return operations.C1APIIamV1RolesUpdateResponse(
                update_roles_response=utils.unmarshal_json(
                    http_res.text, Optional[shared.UpdateRolesResponse]
                ),
                status_code=http_res.status_code,
                content_type=http_res.headers.get("Content-Type") or "",
                raw_response=http_res,
