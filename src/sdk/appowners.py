...
class AppOwners:
    ...
    def add(self, request: operations.C1APIAppV1AppOwnersAddRequest) -> operations.C1APIAppV1AppOwnersAddResponse:
        ...
        url = utils.generate_url(base_url, '/api/v1/apps/{app_id}/owners/{user_id}', request)
        ...
        res = operations.C1APIAppV1AppOwnersAddResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def list(self, request: operations.C1APIAppV1AppOwnersListRequest) -> operations.C1APIAppV1AppOwnersListResponse:
        ...
        url = utils.generate_url(base_url, '/api/v1/apps/{app_id}/owners', request)
        ...
        res = operations.C1APIAppV1AppOwnersListResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def remove(self, request: operations.C1APIAppV1AppOwnersRemoveRequest) -> operations.C1APIAppV1AppOwnersRemoveResponse:
        ...
        res = operations.C1APIAppV1AppOwnersRemoveResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
    ...
    def set(self, request: operations.C1APIAppV1AppOwnersSetRequest) -> operations.C1APIAppV1AppOwnersSetResponse:
        ...
        res = operations.C1APIAppV1AppOwnersSetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type') or '', raw_response=http_res)
