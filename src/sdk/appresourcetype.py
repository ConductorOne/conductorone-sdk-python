...
class AppResourceType:
    ...
    def get(self, request: operations.C1APIAppV1AppResourceTypeServiceGetRequest) -> operations.C1APIAppV1AppResourceTypeServiceGetResponse:
        ...
        res = operations.C1APIAppV1AppResourceTypeServiceGetResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list(self, request: operations.C1APIAppV1AppResourceTypeServiceListRequest) -> operations.C1APIAppV1AppResourceTypeServiceListResponse:
        ...
        query_params = { **utils.get_query_params(operations.C1APIAppV1AppResourceTypeServiceListRequest, request), **query_params }
        headers['Accept'] = 'application/json'
        headers['user-agent'] = self.sdk_configuration.user_agent
        client = self.sdk_configuration.client
        ...
        res = operations.C1APIAppV1AppResourceTypeServiceListResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
