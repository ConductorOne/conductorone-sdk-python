...
res = s.app_entitlements.create(request={
    "app_id": "<id>",
})

if res.create_app_entitlement_response is not None:
    # handle response
    pass
...
res = s.app_entitlements.delete(request={
    "app_id": "<id>",
    "id": "<id>",
})

if res.delete_app_entitlement_response is not None:
    # handle response
    pass
