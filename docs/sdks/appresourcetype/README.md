...
res = s.app_resource_type.create_manually_managed_resource_type(request={
    "app_id": "<id>",
})

if res.create_manually_managed_resource_type_response is not None:
    # handle response
    pass
...
res = s.app_resource_type.delete_manually_managed_resource_type(request={
    "app_id": "<id>",
    "id": "<id>",
})

if res.delete_manually_managed_resource_type_response is not None:
    # handle response
    pass
...
res = s.app_resource_type.update_manually_managed_resource_type(request={
    "app_id": "<id>",
    "id": "<id>",
})

if res.update_manually_managed_resource_type_response is not None:
    # handle response
    pass
