...
res = s.request_catalog_management.force_run_bundle_automation(request={
    "request_catalog_id": "<value>",
})

if res.force_run_bundle_automation_response is not None:
    # handle response
    pass
...
res = s.request_catalog_management.list(request={})
