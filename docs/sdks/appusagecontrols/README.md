...
res = s.app_usage_controls.get(request=operations.C1APIAppV1AppUsageControlsServiceGetRequest(
    app_id='<value>',
))
...
res = s.app_usage_controls.update(request=operations.C1APIAppV1AppUsageControlsServiceUpdateRequest(
    app_id='<value>',
))
